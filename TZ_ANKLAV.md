...
Приложение разрабатывается для регистрации пользователей на игры проводимые Организацией и сохранения данных пользователей в базу данных и управления разрешениями игрокам
...
Визуальное оформление в Приложении №1
